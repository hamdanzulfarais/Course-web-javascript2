...
//     return `Halo, ${nama}`;
// }
// console.log(tampilNama('Hamdaan'));
...
// }
// console.log(tampilNama('haamdan', 'Pagi', 'Semoga harimu menyenangkan!'));
// console.log(tampilNama('haamdan', 'Siang', 'Semoga harimu menyenangkan!'));
// console.log(tampilNama('haamdan', 'Sore', 'Semoga harimu menyenangkan!'));
// console.log(tampilNama('haamdan', 'Malam', 'Semoga harimu menyenangkan!'));
