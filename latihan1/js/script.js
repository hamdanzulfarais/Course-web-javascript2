...
// let rifki = Mahasiswa('hamdan zr', 10);
// let rayani = Mahasiswa('Nisatya', 20);
...
// let hamdan = new Mahasiswa('Hamdan', 10);
// let fika = new Mahasiswa('fika wati', 20);
...
// // Menginstansiasi object menggunakan function declaration
// let hamdan = Mahasiswa('hamdan zr', 10);
// let fahri = Mahasiswa('fahriza', 20);
...
// let hamdan = new Mahasiswa('hamdan zr', 10);
// let diko = new Mahasiswa('diko Putro', 20);
